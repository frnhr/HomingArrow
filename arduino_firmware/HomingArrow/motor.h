...
#define MOTOR_DEADZONE 360.0 / ENCODER_RESOLUTION / 2 * 1.7   // angle erorr that is still ok (not triggering arrow movement)
															  // final multiplier (after "2") defines ammount of overlap between adjecent positioins
